...
function generateReport_SingleDifferential_SEMG_Statistics_Normalized()
    ...
    print_All_SingleDifferential_SEMG_Statistics_Normalized(selection, MU_Data, options);
