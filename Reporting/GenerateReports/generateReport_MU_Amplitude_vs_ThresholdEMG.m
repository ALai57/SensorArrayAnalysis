...
function generateReport_MU_Amplitude_vs_ThresholdEMG()
...
function analyses = get_Analyses()
    analyses.IndividualSubject{1} = @(selection,subjData,options)print_Subject_MU_Amplitude_vs_ThresholdEMG(selection,subjData,options);
end
...
function print_ReportDescription(selection)
    ...
    selection.Font.Size = 16;
    selection.Font.Bold = 0;
    selection.TypeText(['This report contains a summary of MU Amplitude vs. MU Recruitment EMG.' char(13)])  
