...
function generateReport_MU_Amplitude_vs_ThresholdForce_Normalized()
    ...
    print_All_MU_Amplitude_vs_ThresholdForce_Normalized(selection, MU_Data, options);
...
function analyses = get_Analyses()
    analyses.IndividualSubject{1} = @(selection,subjData,options)print_Subject_MU_Amplitude_vs_ThresholdForce_Normalized(selection,subjData,options);
end
