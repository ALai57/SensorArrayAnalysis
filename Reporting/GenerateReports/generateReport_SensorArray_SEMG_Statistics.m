...
function generateReport_SensorArray_SEMG_Statistics()
    ...
    print_All_SEMG_Statistics(selection, MU_Data, options);
...
function analyses = get_Analyses()
    analyses.IndividualSubject{1} = @(selection,subjData,options)print_Subject_SEMG_Statistics(selection,subjData,options); 
end
